...
public class TestWeightedGraph16 extends CommonWG {
    ...
    public void beforeEach() {
        ...
        LV link0 = LVImpl.createHC(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i0, false))));
        LV link1 = LVImpl.createHC(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i1, false))));
