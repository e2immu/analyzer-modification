...
public class TestWeightedGraph15D extends CommonWG {
    ...
    public void beforeEach() {
        ...
        LV linkAR = LVImpl.createHC(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i0, false))));
        assertEquals("*-4-0", linkAR.toString());
        LV linkBR = LVImpl.createHC(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i2, false))));
        assertEquals("*-4-2", linkBR.toString());
        LV linkRS = LVImpl.createHC(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i1, false))));
