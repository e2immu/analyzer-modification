...
public class TestWeightedGraph7B extends CommonWG {
    ...
    public void beforeEach() {
        ...
        LV thisVar_4_map = LVImpl.createHC(new SingleLinks(Map.of(i0, new LinkImpl(i1, false))));
        ...
        Links l01to01 = new SingleLinks(Map.of(i0, new LinkImpl(i00, false), i1, new LinkImpl(i01, false)));
        ...
        LV entry_4_l = LVImpl.createHC(new SingleLinks(0, ALL, true));
        LV entry_4_t = LVImpl.createHC(new SingleLinks(1, ALL, true));
