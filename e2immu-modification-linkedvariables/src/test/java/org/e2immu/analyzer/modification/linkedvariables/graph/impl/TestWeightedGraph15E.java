...
public class TestWeightedGraph15E extends CommonWG {
    ...
    public void beforeEach() {
        ...
        LV linkAR = LVImpl.createDependent(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i1, true),
                i0, new LinkImpl(i0, false)), ALL_INDICES, i0));
        assertEquals("*M,0-2-1M,0|*-0", linkAR.toString());
        LV linkBR = LVImpl.createDependent(new SingleLinks(Map.of(ALL_INDICES, new LinkImpl(i2, true),
