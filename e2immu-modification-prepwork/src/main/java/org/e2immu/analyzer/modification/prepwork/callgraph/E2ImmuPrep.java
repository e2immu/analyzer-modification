...
public record E2ImmuPrep(Runtime runtime,
    ...
    public static E2ImmuPrep makeDoNotAcceptExternals(JavaInspector javaInspector, ParseResult parseResult) {
        return make(javaInspector, parseResult, t -> false, true);
    }

    public static E2ImmuPrep makeAcceptExternalsButNotJdk(JavaInspector javaInspector,
                                                          ParseResult parseResult,
                                                          boolean computeAnalysisOrder) {
        return make(javaInspector, parseResult,
                t -> t.compilationUnit() != null && !t.compilationUnit().partOfJdk(),
                computeAnalysisOrder);
    }

    public static E2ImmuPrep make(JavaInspector javaInspector,
                                  ParseResult parseResult,
